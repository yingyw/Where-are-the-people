...
public class VersionThreeTest {
	...
	private Pair<Integer, Float> v3Pair;
	...
	/** Test scaleBoundary, getTargetPopulation, and getPair in VersionThree */
	@Test
	public void testWholeMapVersionThree() {
		target = new Rectangle(1, 100, 500, 1);
		v3 = new VersionThree(file, 100, 500, target);
		v3Pair = v3.getPair();
		int targetPop = v3Pair.getElementA();
		float percent = v3Pair.getElementB();
		float expected = 100;
	...
	@Test
	public void testHalfMapVersionThree() {
	...
	@Test
	public void generalCase1VersionThree() {
		target = new Rectangle(1, 5, 4, 1);
		v3 = new VersionThree(file, 20, 25, target);
		v3Pair = v3.getPair();
		int targetPop = v3Pair.getElementA();
		float percent = v3Pair.getElementB();
		BigDecimal a = new BigDecimal(percent);
	...
	@Test
	public void generalCase2VersionThree() {
	...
	@Test
	public void generalCase3VersionThree() {
